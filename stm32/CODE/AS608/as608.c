...
{   
	...
	GPIO_InitStructure.GPIO_Mode 	= GPIO_Mode_IN;				//配置IO
...
const char *EnsureMessage(u8 ensure) 
{
	...
	switch(ensure)
	{
		...
		case  0x03:
			p="mqtt录入指纹图像失败\n:";break;
		case  0x04:
			p="mqtt指纹图像太干、太淡而生不成特征\n:";break;
		case  0x05:
			p="mqtt指纹图像太湿、太糊而生不成特征\n:";break;
		case  0x06:
			p="mqtt指纹图像太乱而生不成特征\n:";break;
		case  0x07:
			p="mqtt指纹图像正常，但特征点太少（或面积太小）而生不成特征\n:";break;
		case  0x08:
			p="mqtt指纹不匹配\n:";break;
		case  0x09:
			p="mqtt没搜索到指纹\n:";break;
		case  0x0a:
			p="mqtt特征合并失败\n:";break;
		case  0x0b:
			p="mqtt访问指纹库时地址序号超出指纹库范围\n:";
		case  0x10:
			p="mqtt删除模板失败\n:";break;
		case  0x11:
			p="mqtt清空指纹库失败\n:";break;	
		case  0x15:
			p="mqtt缓冲区内没有有效原始图而生不成图像\n:";break;
		case  0x18:
			p="mqtt读写 FLASH 出错\n:";break;
		case  0x19:
			p="mqtt未定义错误\n:";break;
