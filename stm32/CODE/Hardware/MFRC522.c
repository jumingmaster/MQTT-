...
void STM32_SPI3_Init(void) 
{
	...
	//E
	GPIO_InitStruct.GPIO_Pin 	= GPIO_Pin_7|GPIO_Pin_13|GPIO_Pin_15;	//GPIOE 7 9 13 15
	...
	GPIO_InitStruct.GPIO_Pin  	= GPIO_Pin_9; 			//配置MISO为输入
	GPIO_InitStruct.GPIO_Mode 	= GPIO_Mode_IN;			//推挽输入
	GPIO_InitStruct.GPIO_PuPd 	= GPIO_PuPd_UP; 		//上拉
    GPIO_Init(GPIOE,&GPIO_InitStruct);	
	
	//D
	GPIO_InitStruct.GPIO_Pin 	= GPIO_Pin_0 |GPIO_Pin_9 |GPIO_Pin_14; 	//GPIOD 0 9
	GPIO_InitStruct.GPIO_Mode 	= GPIO_Mode_OUT;						//配置模式
	GPIO_InitStruct.GPIO_Speed 	= GPIO_Speed_50MHz; 					//速度 50MHz
	GPIO_InitStruct.GPIO_OType 	= GPIO_OType_PP; 						//推挽复用输出
	GPIO_InitStruct.GPIO_PuPd 	= GPIO_PuPd_UP; 						//上拉
